# Smart_Parcking_System
IoT-based smart parking system using an ESP32 for real-time slot detection, with a Node.js/Express dashboard for live monitoring, gate control, and slot management.
